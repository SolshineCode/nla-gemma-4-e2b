...
**The first open-source Natural Language Autoencoder (NLA) released independently of Anthropic's NLA team.** Trained end-to-end on a single 4 GB consumer GPU. Open weights, open data, open methodology.
