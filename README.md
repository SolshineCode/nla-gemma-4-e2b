...
Full accounting of all of the above — every number, every judge's raw reasoning, the position-bias checks, and what is/isn't independently re-verified at each checkpoint — is on the [dense1000 model card](https://huggingface.co/Solshine/gemma-4-e2b-nla-L23-av-grpo-dense1000).
